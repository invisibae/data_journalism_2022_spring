...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**: **groups hospitals by type, arranges by number of said hospitals**
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**: filters for general acute care hospitals in MD
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**: a ggplot with only a geometry layer denoting points by lat-long
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**: **Gives us a nice list of counties**
```{r}
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**: a *slightly wrong* map of MD
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**: we now how the shape and the points layer on top
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**: color the points by number of beds
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**: **gives us total number of hospital beds per county and makes it into a new df**
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**: **Loads county population data from ACS and filters for Maryland counties.**
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**: **adds each county's geometry*
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**: **loads both df's so we can see the column inconsistencies**
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**: **Cleans the ACS data to match the format of the 'md_beds' df**
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**: **calculate beds per 100k with mutate and arrange in descending order**
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**: **makes a very nice map with fill mapped to beds per 100k**
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**: **changes our scale fill to give the viewer a better idea of what's going on**
...
```{r}
ggplot() +
  geom_sf(data=wv_mining_per_100k, aes(fill=loans_per_100k, geometry = geometry)) +
  theme_minimal() +
