...
**Answer** Copy the url of the graphic you published here.: ***https://datawrapper.dwcdn.net/ARSca/1/***
...
**Answer** Describe what the code below is doing and the output.: **using the count function to make a pivot table**
...
**Answer** Describe what the code below is doing and the output.: **filtering for county names that appear over 6 times to cull some of our out of staters**
...
**Answer** Describe the contents of the new `fips_code` column: **fips codes denoting each county**
...
**Answer** Describe the changes from the previous map: **w get a map of Maryland**
...
**Answer** Describe the changes from the previous map **our number of PPP loans by county is now formatted correctly and each icon displays the name of a county**
...
**Answer** Put the URL of your map here.: ***https://datawrapper.dwcdn.net/TAAIg/2/***
