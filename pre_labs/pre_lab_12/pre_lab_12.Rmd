...
**Answer**" **Reads in the csv from the internet, cleans variable names, and views the resulting table**
...
**Answer**: **Groups vaccination data by county, counts how many days a county has reported full vaccinations, and arranges by that total**
...
**Answer**: **These entries are missing a county.  My first instict is these are vaccines where either the person's home county is unknown or vaccines that were administered within some kind of seperate system that operates within the state (like federal prisons)**
...
**Answer**: **It produces a list of list of dates and ranks them based on how many People in PG County (PG County Residents?  People who got vaccinated in PG County?) became fully vaccinated on that date**
...
**Answer**: **produces an enormous histogram showing number of people who became fully vaccinated by date**
...
**Answer**: **uses the paste function as well as the direction and changetext objects we've just created to assemble a setence that tells us the status of PG County's vaccination efforts**

```{r}
sub <- paste("The number of people in Prince George's County who got fully vaccinated on ", format(latest_date$vaccination_date, format="%B %d"), " ", direction, " by ", changetext, "% compared to the week before", sep="")
sub
```

### Task 13: Produce a description for your bar chart based on the variables in Task 11
**Task** Run the following code and put the value of `sub` in the answer.
**Answer**: **"The number of people in Prince George's County who got fully vaccinated on March 06 decreased by -73.77% compared to the week before"**
...
**Answer**: **Number of total covid cases by county, by date**
...
**Task** Run the following code and describe what the resulting chart shows
**Answer**: **Number of covid cases by date on a log scale**
...
**Answer**: **Total number of COVID cases in MD mapped by county**
