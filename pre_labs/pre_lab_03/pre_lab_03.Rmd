...
**Answer**: **yes it is.  We can conclude that they are the same records**
...
**Answer**: **minimum:6, maximum: 10,000,000**
```{r}
...
**Answer**: **it's trying to add up character data which is by definition impossible**
...
**Answer**: **1 duplicate: 2 instances of Stuart Jones LLC**
...
**Answer**: **This new dataset contains 5 rows representing 5 unique businesses.  The code below first cleans names, then renames the "x1_id" column to something that makes a little more sense, changes the "amount" column's data type to numeric, and then filters for only distinct columns**
...
**Answer**: **This is wonderful illustration of why str_sub() is such a powerful function.  The code below allows us to easily dictate how long we want our strings to be without a lot of annoying consequences.**
