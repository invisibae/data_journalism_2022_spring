...
**Answer**: Reads in the data.  A list of tweets by members of congress structured so that it can be filtered by a variety of variables 
...
**Answer** keeps only unique values.  
...
**Answer**: Isolates each unique word that appears in the 'content' column of the data
...
**Answer**: the most common words found in congressional tweets.  No it is not interesting.  
...
**Answer**: we've removed a bunch of boring stop words.  Now it is significantly more interesting because it tells a relatively coherent story.  
...
**Answer**: df's of top words for both 2020 and 2021.  2021's main difference is the rise in mentions of the vaccine and vaccination.
...
**Task** Run the following code and describe the results.
**Answer**: most common bigrams in the congressional tweets from 2020.  Lots of covid and public health stuff.  
...
**Task** Run the following code and describe the results.
**Answer**: even more evident in this list of most common bigrams from 2021 the impact the vaccine had on the covid discourse.
...
**Task** Run the following code and describe the results.
**Answer**: Democrats' tweet volume is a lot higher and they seem a bit more concerned with covid relief where democrats mentioned things like public health and social distancing more often
...
**Task** Run the following code and describe the results.
**Answer** "covid positive" lol, but what's notable for me apart from that is 'vaccine mandate' entering the conversation in 2021 and being mentioned so often given the fact that most people had no access to the vaccine for at least a quarter of 2021.  
...
**Answer**: 'positive' vs 'negative' is simply too simple of a binary to encompass the entire English language.  While I think the sentiment analysis does a half decent job, there are obvious problems.  A word like 'important' being labled positive belies the fact that 'important' things are sometimes negatie.  Similarly "Critical" news is not always negative.  
