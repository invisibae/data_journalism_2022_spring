...
```{r}
voters_by_county <- read_csv("md_voters.csv")
...
```{r}
lender_types <- read_csv("ppp_tabula.csv")
View(lender_types)
```
...
```{r}
lender_types <- read_csv("ppp_tabula.csv", skip=1, col_names=c("type", "count", "approved", "net_dollars"))
